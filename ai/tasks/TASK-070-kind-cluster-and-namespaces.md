# TASK-070 — kind Cluster and Namespaces

## Objective
Create reproducible kind cluster config and platform namespace(s). Document create/delete/recreate, kubectl verification and local-image loading. Do not deploy services yet.

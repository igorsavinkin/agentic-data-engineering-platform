# TASK-061 — parquet_compaction DAG

## Objective
Create safe Parquet compaction DAG. Compact eligible small files while preserving records, schema and partition semantics. Validate replacement before source removal and handle replay/partial failure safely.

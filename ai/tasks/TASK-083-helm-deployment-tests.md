# TASK-083 — Helm Deployment Tests

## Objective
Run lint/render validation and install/upgrade the chart in kind. Verify workloads/config, representative upgrade, removal/rollback where practical, existing health behavior, no default real secrets, and optional resources remain disabled as configured.

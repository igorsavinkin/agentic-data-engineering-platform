# TASK-068 — Data Quality API

## Objective
Expose persisted latest/historical data-quality results with bounded filters by check/source/dataset/status/time where supported. Preserve established quality severity/status semantics. Do not execute checks in request handlers.

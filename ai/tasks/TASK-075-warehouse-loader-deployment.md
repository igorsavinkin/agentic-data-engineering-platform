# TASK-075 — Warehouse Loader Deployment

## Objective
Add Warehouse Loader Deployment preserving Gold/Parquet→PostgreSQL and idempotent loading. Externalize DB/storage config and avoid concurrent migration ownership mistakes.

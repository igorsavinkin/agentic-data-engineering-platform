# TASK-090 — OpenTelemetry

## Objective
Introduce shared OpenTelemetry configuration/instrumentation with consistent resource identity, configurable exporters and bounded safe attributes. Prepare meaningful service boundaries for distributed tracing.

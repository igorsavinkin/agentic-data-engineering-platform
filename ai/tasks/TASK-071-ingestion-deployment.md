# TASK-071 — Ingestion Deployment

## Objective
Add Kubernetes Deployment for ingestion. Externalize Kafka/source config, preserve adapter/publisher architecture, labels/selectors and observable logs. No unnecessary inbound Service.

# TASK-072 — Processor Deployment

## Objective
Add processor Deployment preserving Kafka consumer-group, processing, graceful shutdown and offset semantics. Externalize topics/bootstrap config and keep processor independent.

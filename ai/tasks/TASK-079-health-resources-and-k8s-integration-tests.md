# TASK-079 — Health Probes, Resources and Kubernetes Integration Tests

## Objective
Add meaningful probes, local-development CPU/memory requests/limits and integration smoke tests. Intentionally reproduce, diagnose and recover CrashLoopBackOff, ImagePullBackOff, readiness failure, OOMKilled and missing configuration.

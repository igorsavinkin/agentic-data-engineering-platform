# TASK-073 — Raw Writer Deployment

## Objective
Add Raw Writer Deployment preserving Kafka→Bronze responsibility and idempotency. Externalize Kafka/object-storage config; reference Secrets, never literal credentials.

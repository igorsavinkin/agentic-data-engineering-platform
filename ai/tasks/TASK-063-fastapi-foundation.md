# TASK-063 — FastAPI Foundation

## Objective
Create `services/api/`: application factory, lifespan, typed config, DB dependency/session lifecycle, health/readiness, versioned API prefix, Pydantic response conventions, structured errors and OpenAPI. Keep DB/query logic out of routes.
